...
public class TriviaTaskView extends JLayeredPane {
    ...
    TriviaTaskView(){
        ...
        JLabel currentRandomQuestion = new JLabel(presenter.tellViewQuestion());
        ...
        submitButton.addActionListener(e -> {
            ...
            controller.passAnswer(playerAnswerInput);
            String correctnessMessage = presenter.tellCorrectness();
